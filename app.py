...
# ==========================================
# 1. INISIALISASI FIREBASE (FIX PEM PRIVATE KEY)
# ==========================================
if not firebase_admin._apps:
    try:
        key_dict = dict(st.secrets["firebase"])
        
        # Perbaikan error "Invalid symbol 95": Mengubah '\\n' literal menjadi newline '\n'
...
# ==========================================
# 8. PANEL SISWA (ANTI-CHEAT FIXED & PEM FIX INTEGRATED)
# ==========================================
def render_siswa():
    ...
    # CSS Khusus: Menyembunyikan tombol trigger anti-cheat dari UI
    st.markdown("""
        <style>
        .ac-hidden-trigger {
